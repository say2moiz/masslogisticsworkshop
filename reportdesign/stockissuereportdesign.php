...
.header{width:100%; background-color:#000; height:30px; top:0px; position:fixed; color:white; text-align:center; line-height:30px;}
.footer{width:100%; background-color:#000; height:30px; bottom:0px; position:fixed;color:white; text-align:center; line-height:30px;
...
<?php
        ...
        $issuerdd='';
        ?>
        <select class="issuefilter" name='issue' id="issuerdd" onchange='this.form.submit();'>
            <!-- aik control bnao aisa jime bht sare options mill sake-->
            ...
            while($row=mysql_fetch_array($result))
            {
                ...
                <!--jese id hoti he wese he class hoti he styling k kaam ati he, aik classs bht sari
                cheezo ko day skte han lakin id aik c zayada chezo ki aik jesi nai hoskti -->
                <option  value='<?php echo $issuerid; ?>'<?php if (isset($_GET['issue'])){ if($issuerid==$_GET['issue']) echo 'selected="selected"';}?>>
                    <?php echo $issuername;?>
                </option> <!-- option ye hoge hamare control me -->
...
$pickerdd='';
?>
<select class="pickfilter" name='pick' id="pickerdd" onchange='this.form.submit();'>
    <!-- aik control bnao aisa jime bht sare options mill sake-->
    ...
    while($row=mysql_fetch_array($result))
    {
        ...
        <!--jese id hoti he wese he class hoti he styling k kaam ati he, aik classs bht sari
        cheezo ko day skte han lakin id aik c zayada chezo ki aik jesi nai hoskti -->
        <option  value='<?php echo $pickername; ?>'<?php if (isset($_GET['pick'])){ if($pickername==$_GET['pick']) echo 'selected="selected"';}?>>
            <?php echo $pickername;?>
        </option> <!-- option ye hoge hamare control me -->
