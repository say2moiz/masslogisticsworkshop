...
$reportname="Delete Scrap Receivers";
?>
<!DOCTYPE HTML>
<html>
<head>
...
<div id="reportContainer" class="clearfix">
    ...
    <body>
    <?php
    if (isset($_GET['scrapreceiverid'])) { $scrapreceiverid = $_GET['scrapreceiverid']; }
    else { header('location:viewscrapreceiver.php'); }
    if ($scrapreceiverid != '')
    {
        ...
        <div id="containerInner">
            <form method="post">
                <div class="form clearfix">
                    <div class="formHead">Delete Scrap Receiver</div>
                    <div class="formFoot clearfix">
                        <span>Are you sure? you want to delete the above scrap receiver? if yes click delete. Or click  cancel to go back.</span>
                        <input type="submit" name="submit" value="Delete" id="submit">
                        <input type="button" name="cancel" value="Cancel" id="cancel"
                               onclick="window.location='viewreceivers.php'">
                    </div>
                </div>
            </form>
        </div>
    ...
    {
        $qryDeletePermit="select * from stock where idReturn='$scrapreceiverid'";
        ...
        {
            $qry = "delete from return1 where idReturn='$scrapreceiverid'";
            $result = mysql_query($qry) or die(mysql_error());
        ...
        else
        {
            ...
            <script>
                ...
                $('#responseMsg').html('<img id="addResponseImg" style="visibility: hidden"; src="images/failure.png" width="20">' +
                    '<span id="msg">Alert!!! You cannot delete this scrap receiver because this buyer have purchased anything for you.</span>');
                $('#responseMsg').show();
                setTimeout(function(){
